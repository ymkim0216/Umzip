...
public enum StatusCode {
    ...
    FAIL_TO_RESERVATION(false, 203, "예약에 실패했습니다."),
    // MEMBER : 300
    ...
    INVALID_ACCESS_DELIVERY(false,606,"요청한 업체와 수정 적용 대상이 다른 대상입니다."),
    ...
    INVALID_ACCESS_CLEAN_MAPPING(false,804,"요청한 유저와 로직 적용 대상이 다른 유저입니다."),
