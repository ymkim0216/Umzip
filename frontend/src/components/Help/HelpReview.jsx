...
import AddBlueButton from "../MainPage/DashBoard/AddBlueButton"
import AddRedButton from "../MainPage/DashBoard/AddRedButton"
import StarRating from "../Recommend/StarRating"
export default function UsedReview({ setStatus, onClose, to }) {
    ...
    return <>
        {to && tags && !isloading && <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={handleClose}
            style={{
                zIndex: "99",
                position: 'fixed',
                top: 0,
