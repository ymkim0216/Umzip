            ...
            <div className="d-flex flex-column   " >
                ...
                <AnimatePresence mode="wait">
                    <motion.div className="d-flex flex-column gap-4" >
                        ...
                        {helpYouList.length===0 && <div className="d-flex gap-3 justify-content-center align-items-center"><p>아직 작성 글이 없습니다!</p><img style={{width:"3rem",height:"3rem"}} src="./free-animated-icon-note-6172546.gif"/></div>}
