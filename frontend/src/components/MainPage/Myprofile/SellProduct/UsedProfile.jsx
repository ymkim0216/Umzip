...
export default function UsedProfile({id,img,title,status,price}) {
    ...
    return <>
        <motion.div whileHover={{y:-5 , cursor:"pointer"}} onClick={handleClick} className="d-flex p-2 rounded-4 shadow align-items-center gap-3"  initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}> 
