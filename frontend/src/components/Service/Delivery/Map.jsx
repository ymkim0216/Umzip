...
const Map = ({ start_lat, start_lon, end_lat, end_lon }) => {
    ...
    const handleSelectChange = (event) => {
        // 여기서 셀렉트 박스의 선택값에 따라 state를 변경하거나 필요한 작업 수행
    };

    const handleYearChange = (event) => {
        // 여기서 년도 셀렉트 박스의 선택값에 따라 state를 변경하거나 필요한 작업 수행
    };

    const handleClick = () => {
        // 여기서 버튼 클릭 시 필요한 작업을 수행
        // 예를 들어, AJAX 호출 등...
    };
